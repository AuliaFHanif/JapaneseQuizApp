...
└── app/
    ...
    ├── QuestionBank.js   # Main dataset for vocabulary and quiz questions
    ├── QuestionBank.txt  # Raw text format of the question bank
...
- **Data Management**: The app uses static JavaScript files (`QuestionBank.js` and `KanjiBank.js`) to load thousands of vocabulary words and Kanji characters instantly into memory.
